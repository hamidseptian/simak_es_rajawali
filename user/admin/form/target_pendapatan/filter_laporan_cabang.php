...
<div class="box-header with-border">
  ...
  <div class="pull-right">
     <a href="form/laporan/print_laporan_cabang_bulanan?bulan=<?php echo $bl ?>&tahun=<?php echo $th ?>" class="btn btn-default btn-sm"  data-toggle="modal" data-target="#add">Print</a>
