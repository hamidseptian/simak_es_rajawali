          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
               ...
               <?php 
                $qbb = mysqli_query($conn, "SELECT bb.id_bahan_baku, bb.nama_bahan_baku, bb.satuan,
    ...
    from bahan_baku bb"); 
                ...
                while ($dbb = mysqli_fetch_array($qbb)) { ?>
                  <tr>
                    ...
                    <td><?php echo ($dbb['penambahan_stok'] - $dbb['stok_keluar']).' '.$dbb['satuan'] ?></td>
                    <td>
              ...
              <div class="modal-body">
                ...
                <?php 
                  $qpbk = mysqli_query($conn , "SELECT a.id_managemen, a.id_bahan_baku, a.qty, a.satuan, c.nama_bahan_baku, b.nama_cabang, c.stok from management_bahan_baku a 
                    ...
                    where jenis='Keluar' and mbb.id_cabang ='$id_cabang'");
                  $no2 = 1;
...
<hr>
<?php 
  $q1=mysqli_query($conn, "SELECT tgl_transaksi, count(id_managemen) as jmlitem from management_bahan_baku where id_cabang = '$iduser' group by tgl_transaksi
    ");
  $no=1;
 ?>
 ...
 <table class="table table-striped table-bordered" id="example1">
  ...
  <tr>
    ...
    <td>
      <a href="?a=detail_permintaan_bahan_baku&tgl=<?php echo $d1['tgl_transaksi'] ?>" class="btn btn-info btn-xs">Detail</a>   
    </td>
  </tr>
  <?php } ?>
</table>